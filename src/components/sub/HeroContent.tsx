		...
		<motion.div
			...
			<motion.div variants={itemVariants} className="space-y-6">
				...
				<div className="relative">
					...
					<div className="absolute -bottom-2 -left-2 w-6 h-6 bg-accent-2/30 rounded-full animate-pulse"></div>
				</div>

				{/* Role with Modern Design */}
				<div className="relative">
					<div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-accent-2/10 to-primary/10 rounded-2xl blur-xl"></div>
					<div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
						<h2
							title="DevOps & Cloud Engineer"
							className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-accent-2 to-primary bg-clip-text text-transparent mb-3">
							DevOps & Cloud Engineer
						</h2>
						<div className="w-24 h-1 bg-gradient-to-r from-primary to-accent-2 rounded-full mx-auto"></div>
					</div>
				</div>
				...
				<motion.p
					...
					Building resilient cloud & on-premise Infrastructure — from Kubernetes
					clusters to automated delivery pipelines.
				</motion.p>
			</motion.div>
			...
			<motion.div
				...
				<NavbarButton
					variant="primary"
					className="group relative overflow-hidden bg-gradient-to-r from-primary to-accent-2 hover:from-accent-2 hover:to-primary text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
					...
					<div
						...
						className="absolute inset-0 bg-white/20 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
				</NavbarButton>
