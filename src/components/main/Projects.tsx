  ...
  return (
    <section id="projects" className="relative pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 title="My Projects" className="text-4xl md:text-5xl font-bold text-heading-gradient mb-4">
            My Projects
          </h1>
        ...
        {projectsData.map((project) => (
          <div key={project.title} className="relative md:col-span-2">
            <BentoGridItem
              ...
              header={
                <div className="relative w-full h-full [@media(max-width:425px)]:min-h-[9rem] min-h-[6rem] rounded-xl overflow-hidden bg-gradient-to-br from-primary/20 via-accent-2/10 to-transparent flex items-center justify-center">
