...
export const timelineData: TimelineItem[] = [
  {
    ...
    description: 'Multi-cloud infrastructure engineering across AWS and GCP with focus on automation and reliability.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Match administration and refereeing for Rocket League Championship Series in the South American region, with occasional EU events.',
    achievements: [
