  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-accent-2/20 rounded-lg rotate-45 animate-bounce"></div>
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-80 h-80 bg-gradient-to-r from-primary/20 via-accent-2/10 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-60 h-60 bg-gradient-to-l from-accent-2/15 via-primary/10 to-transparent rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="w-full max-w-6xl relative z-10">
        ...
        >
          {skillsToShow.map((skill, index) => (
            ...
            >
              {/* Glow effect */}
              <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-primary/20 via-accent-2/10 to-transparent blur-sm"></div>
        ...
        {uniqueSkills.length > maxItemsToShow && (
          ...
          >
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-r from-primary to-accent-2 hover:from-accent-2 hover:to-primary text-primary-foreground px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
