...
const educationData: EducationItem[] = [
  {
    ...
    date: '2020 – 2025',
    description:
      'Formación en ingeniería de software con foco en sistemas, redes y desarrollo. Complementé la carrera con especialización autodidacta en infraestructura cloud, Kubernetes y prácticas DevOps.',
  },
]
...
const certificationsData: CertificationItem[] = [
  {
    ...
    date: 'Nov 2025',
    description:
      'Capture The Flag de seguridad cloud enfocado en explotación de infraestructura y vulnerabilidades en entornos cloud-native.',
    highlight: '🏆 3rd Place',
    isAward: true,
  },
  {
    ...
    issuer: 'Cisco',
    date: 'Ago 2022',
    description: 'Fundamentos de ciberseguridad, amenazas comunes y mejores prácticas defensivas.',
  },
  {
    title: 'Cybersecurity Essentials',
    issuer: 'Cisco',
    description: 'Conceptos avanzados de ciberseguridad, criptografía y gestión de riesgos.',
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Mi formación académica y reconocimientos técnicos.
          </p>
        </motion.div>
